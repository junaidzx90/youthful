  ...
  <div class="container">
    ...
    <div class="row mx-0">
      ...
      <div class="profile-info col-md-8 col-sm-12 px-md-0">
        <button type="button" class="btn btn-success create-new-trip">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          <li class="nav-item">
            <a
              ...
              id="trip-condition-tab"
              data-toggle="tab"
              href="#trip-condition"
              role="tab"
              aria-controls="trip-condition"
              aria-selected="true"
              >ট্রিপের অবস্থা</a
            >
          </li>
        ...
        <div class="tab-content" id="myTabContent">
          ...
          >
            ...
            >
              ...
              <div id="client">
                <div
                  class="row mx-0 justify-content-center client-dashboard"
                >
                  ...
                  <div class="active-trip-info mt-2 driver-dashboard">
                    <p class="p-3 text-info">
                      <i class="blockquote">
                        ...
                        তৈরিতে ব্যবহৃত হয়। প্যারাংশটি 15 ম শতাব্দীর এক
                  ...
                  <?php
                    ...
                    if($posts){
                      ...
                      $trips = $wpdb->get_results("SELECT * FROM $bidtbl WHERE client_id = $current_user->ID AND bid_status = 'pending' || bid_status = 'inprogress' || bid_status = 'aweting'");
                    }
                    ...
                    if($wpdb->num_rows>0){
                      ...
                      foreach($trips  as $trip){?>
                        <div class="card p-0 mb-2 active-item">
                          <div
                            <?php if($trip->bid_status == 'inprogress') echo 'style="background: #28a79b42;"'; ?>
                            class="card-header"
                            role="tab"
                            id="trip_item_<?php echo $i; ?>"
                          >
                            <div
                              class="trip-pending-content d-flex justify-content-between"
                            >
                              <p>
                                <?php echo get_post_meta( $trip->post_id, 'load_point_0', true) ?><strong class="bahak">
                                  থেকে </strong
                                ><?php echo get_post_meta( $trip->post_id, 'unload_point_0', true) ?>
                              </p>

                              <div class="btn-group mb-2">
                              <?php

                               $aweting = $wpdb->get_var("SELECT bid_status FROM $bidtbl WHERE bid_status = 'aweting' AND client_id = $current_user->ID AND post_id = $trip->post_id");
                                ...
                                if($trip->bid_status == 'inprogress'){
                                  ...
                                  echo '<button data-id="'.intval($trip->post_id).'" data-uid="'.intval($trip->user_id).'" type="button" class="btn btn-success trip-approve"> গ্রহণ করুন </button>';
                            ...
                            <h5 class="mb-0">
                              <a
                                class="trip-condition-tab"
                                data-toggle="collapse"
                                data-parent="#accordianId"
                                href="#trip_item_link_<?php echo $i; ?>"
                                aria-expanded="true"
                                ...
                                <blockquote class="blockquote">
                                  <footer class="card-blockquote">
                                    <strong>ট্রাক লোডের সময় : </strong>&nbsp;<span
                                      title="Source title"
                                      ><?php echo get_post_meta( $trip->post_id, 'loadtime', true) ?></span>
                              ...
                              >
                                <tbody>
                                  <tr>
                                    ...
                                    <td class="table-data-body"><?php echo __(get_post_meta($trip->post_id, 'typeoftruck', true),'youthful') ?></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td class="table-data-body"><?php echo __(get_post_meta($trip->post_id, 'loadtime', true),'youthful') ?>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td class="table-data-head">লেবার</td>
                                    <td class="table-data-body"><?php echo __(get_post_meta($trip->post_id, 'need_laborer', true),'youthful') ?></td>
                                  </tr>
                                  <tr>
                                    <td class="table-data-head">মালের ধরণ</td>
                                    <td class="table-data-body"><?php echo __(get_post_meta($trip->post_id, 'typeofgoods', true),'youthful') ?></td>
                                  </tr>
                                  <tr>
                                    <td class="table-data-head">মালের ওজন</td>
                                    <td class="table-data-body"><?php echo __(get_post_meta($trip->post_id, 'weights', true),'youthful') ?></td>
                                  </tr>
                                  <tr>
              ...
              <div class="card p-0 mb-2 payment-hist-item">
                <div class="card-header" role="tab" id="section1HeaderId">
                  <h5 class="mb-0">
                    <a
                      data-toggle="collapse"
                      data-parent="#payment-doc"
                      href="#paymentsection1ContentId"
                      aria-expanded="true"
                      aria-controls="paymentsection1ContentId"
                      class="d-block"
                    >
                      কাঁচামাল ৫ টন, ঢাকা থেকে চাঁদপুর, ৫-টন ১-ঘোরা ট্রাক
                      <span class="price-was float-right text-info"
                        >১০,৫০০ টাকা</span
                      >
                    </a>
                  </h5>
                ...
                >
                  <div class="card-body">
                    <h4 class="m-0 d-block">
                      <span class="place-title float-left"
                        >ঢাকা
                    ...
                    >
                      ...
                      <span class="badge badge-danger commision"
                        >৫০০ টাকা কমিশন</span
                      >
                    </div>
                    <table
                ...
                <div class="card-header" role="tab" id="section1HeaderId">
                  <h5 class="mb-0">
                    <a
                      data-toggle="collapse"
                      data-parent="#payment-doc"
                      href="#paymentsection2ContentId"
                      aria-expanded="true"
                      aria-controls="paymentsection2ContentId"
                      class="d-block"
                    >
                      কাঁচামাল ৫ টন, ঢাকা থেকে চাঁদপুর, ৫-টন ১-ঘোরা ট্রাক
                      <span class="price-was float-right text-info"
...
<!-- CREATE PROPOSAL POPUP WIDGET -->
<?php require_once("create_proposal_form.php") ?>
