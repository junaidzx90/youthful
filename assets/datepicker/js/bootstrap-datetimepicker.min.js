(function (a) {
  ...
  var g = function (k, j) {
    var m = this;
    this.element = d(k);
    this.container = j.container || ".form_datetime";
    ...
    this.component = this.element.is(".date")
      ? this.bootcssVer === 3
        ? this.element
            .find(
              ".input-group-addon .fas-th, .input-group-addon .fas-time, .input-group-addon .fas-remove, .input-group-addon .fas-calendar, .input-group-addon .fa-calendar, .input-group-addon .fa-clock-o"
            )
            .parent()
        : this.element
            .find(
    ...
    this.componentReset = this.element.is(".date")
      ? this.bootcssVer === 3
        ? this.element
            .find(
              ".input-group-addon .fas-remove, .input-group-addon .fa-times"
            )
            .parent()
